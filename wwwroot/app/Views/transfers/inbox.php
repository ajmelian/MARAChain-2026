...
/**
 * Inbox view — transfers received by the authenticated user.
 *
 * @var array<int, \App\Entities\DocumentTransfer> $transfers List of received transfers
...
<div class="row clearfix">
    <div class="col-lg-12">
                ...
                <div class="row clearfix">
                    <div class="col-md-6">
                        <div class="input-group">
                            <input type="text" class="form-control" id="searchInbox" placeholder="Buscar por remitente o documento...">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-pills">
                            <?php foreach ($filterParams as $statusKey => $filterLabel): ?>
                                <?php
                                $href       = $statusKey === '' ? '/transfers/inbox' : '/transfers/inbox?status=' . urlencode($statusKey);
        ...
        <div class="card">
            <div class="header">
                <h2><strong>Transferencias</strong> recibidas</h2>
            </div>
            <div class="body">
                ...
                <?php else: ?>
                    ...
                    <ul class="list-unstyled mail_list" id="inboxList">
                        <?php foreach ($transfers as $transfer): ?>
                            ...
                            $isUnread   = in_array($status, ['PENDING_RECIPIENT', 'AVAILABLE', 'SENT'], true);
                            ...
                            <li class="<?= $rowClass ?>" onclick="window.location='/transfers/<?= esc($transfer->id) ?>'" style="cursor: pointer;">
                                ...
                                <div class="media-body">
                                    <div class="thumb">
                                        <span class="rounded-circle d-inline-flex align-items-center justify-content-center bg-secondary text-white" style="width: 40px; height: 40px; font-size: 16px; font-weight: 600;">
                                            <?= strtoupper(substr(esc($transfer->senderId), 0, 1)) ?>
                                        </span>
                                    </div>
